...
const toolDefinitions = [
  ...
  { name: "annotatekit_watch_send", description: "Wait until the developer taps Send in AnnotateKit, then return the pending annotations from that iOS session. Use this in an active Codex or Cursor conversation for a hands-free annotate, send, implement loop.", inputSchema: { type: "object", properties: { sessionId: { type: "string" }, timeoutSeconds: { type: "integer", minimum: 1, maximum: 300, default: 120 } }, additionalProperties: false }, annotations: { title: "Watch for iOS feedback", readOnlyHint: true, openWorldHint: false, destructiveHint: false } },
